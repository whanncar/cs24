/*
 * Implementation of "object oriented" programming using an "abstract
 * class" Shape and the "subclasses" Box, Sphere, and Cone.
 *
 */
...
float Cone_getVolume(Cone_Data *this) {
    ...
    return (M_PI * this->base_radius * this->base_radius * this->height) / 3;

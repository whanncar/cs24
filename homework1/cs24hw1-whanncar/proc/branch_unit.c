...
void branch_test(BranchUnit *bru) {
	...
	/*if the alu opcode is BNZ*/

	if(aluop == ALUOP_BNZ && A){

		/*set the branch value on the bus to 1 (that is, to branch)*/

		pin_set(bru->branch, BRANCH);

	}

	/*if the alu opcode is not BNZ*/

	else{

		/*set the branch value on the bus to 0 (that is, to not branch)*/
